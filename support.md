...
If you encounter a bug or crash, please email us with:
...
- Make sure you tap "Finish Workout" at the end of your session. Closing the app mid-workout may result in lost data.
- If the app was running in the background, your workout timer and data should be preserved when you return.

### Backup and Restore

- **Create a backup**: Settings > Data > Download My Data.
- **Restore from backup**: Settings > Data > Restore From Backup, then select your backup JSON file.
- **Automatic backups**: Settings > Data > Auto-Backup. Choose a frequency and backup folder.
